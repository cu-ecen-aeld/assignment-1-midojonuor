...
void test_validate_my_username()
{
     ...
     */
    const char *pMyUsername = my_username();
    const char *pAllocUsername = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(pAllocUsername, pMyUsername, NULL);
}
